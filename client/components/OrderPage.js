        ...
        {user.id ? (
          <div>
            ...
            {openOrder.id ? (
              <div>
                <h1>
                  {this.props.user.username}'s Total: ${(openOrder.total / 100).toFixed(2)}
                </h1>
                ...
                {products.length ? (
                  <button
                    className="checkout"
                    type="checkout"
                    onClick={() => this.props.checkout(openOrder)}
                  >
                    Checkout
                  </button>
                ) : (
            ...
            {!user.id ? (
              <div>
                <h1>
                  Guest's Total: $
                  {(
                    guestItems.reduce((acc, product) => acc + product.price * product.quantity, 0) /
                    100
                  ).toFixed(2)}
                </h1>
